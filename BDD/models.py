...
from BDD.choices import SEXE, TYPE, INCONNU_STATUT, \
    ...
    TYPENEWSG, AJOUT, INCONNU_STATUT_MOD, TYMO
...
class Modification(models.Model):
    ...
    datemodif = models.DateTimeField(default=datetime.now)
    typetable = models.CharField(max_length=200, null=True)
    typemod = models.IntegerField(choices=TYMO, default=INCONNU_STATUT_MOD)
...
class Personne(models.Model):
    """
        ...
        It also has an upload date.
        
        It also has a filter (which defines a person in a unique way), used in forms.
...
class Groupe(models.Model):
    ...
    personnes = models.ManyToManyField(Personne, blank=True)
    uploadDate = models.DateTimeField(default=datetime.now())
...
class Module(models.Model):
    """
        ...
        A module also has an uploadDate
...
class Note(models.Model):
    """
        ...
        It is related to persons (the persons marked and in an other place professors)
...
class TypeCour(models.Model):
    """
        ...
        It is related to persons (professors) and groups (ManytoMany relations)
...
class Cour(models.Model):
    """
        ...
        It has a name, an upload date, 2 integers which represent the start and the end of the lesson in 
        weeks, 2 others for the hours and another for the day.
...
class News(models.Model):
    """
        ...
        It has a text, an upload date and 2 types of news (delete or add... and the kind of object).
