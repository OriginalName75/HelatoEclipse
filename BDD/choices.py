...
TYPENEWS = ((INCONNU_STATUT_TYPE, 'Statut Inconnu'), (SALLESTATUT, 'SALLE'), (PERSONNESTATUT, 'personne'), (GROUPESTATUT, 'groupe'), (UVSTATUT, 'uv'), (MODULESTATUT, 'module'), (CALENDRIERSTATUT, 'cour'), (COURTYPESTATUT, 'type de cour'), (NOTESTATUT,'notes'))
TYPENEWSG = ((AJOUT, 'ajout'), (MODIFIER, 'modifier'), (SUPRIMER, 'supprimer'))
