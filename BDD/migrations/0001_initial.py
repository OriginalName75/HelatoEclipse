    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uploadDate', models.DateTimeField(default=datetime.datetime(2016, 3, 8, 15, 40, 28, 560032))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('typeG', models.IntegerField(choices=[(0, 'ajout'), (1, 'modifier'), (2, 'supprimer')], default=0)),
                ('uploadDate', models.DateTimeField(default=datetime.datetime(2016, 3, 8, 15, 40, 28, 568037))),
            ],
        ),
        migrations.CreateModel(
            name='Note',
            fields=[
                ...
                ('uploadDate', models.DateTimeField(default=django.utils.datetime_safe.datetime.now)),
                ('isvisible', models.BooleanField(default=True)),
                ('module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BDD.Module')),
            ],
        ),
        migrations.CreateModel(
            name='Personne',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=30)),
                ('uploadDate', models.DateTimeField(default=datetime.datetime(2016, 3, 8, 15, 40, 28, 562033))),
                ('isvisible', models.BooleanField(default=True)),
            ],
        ),
        migrations.AddField(
